...
function A(n2, l2, u2, t3, i2) {
  ...
  if (a3)
    for (r2 = 0; r2 < s2; r2++)
      null != (e2 = u2[r2]) && 0 == (2 & e2.__u) && (e2.__e == t3 && (t3 = S(e2)), E(e2, e2));
  return t3;
}
function H(n2, l2, u2, t3) {
  ...
  if ("function" == typeof n2.type) {
    for (i2 = n2.__k, r2 = 0; i2 && r2 < i2.length; r2++)
      i2[r2] && (i2[r2].__ = n2, l2 = H(i2[r2], l2, u2, t3));
    return l2;
  }
  ...
  n:
    if ("style" == l2)
      if ("string" == typeof u2)
        ...
        if (u2)
          for (l2 in u2)
            t3 && u2[l2] == t3[l2] || j(n2.style, l2, u2[l2]);
      }
    ...
    if ("function" == typeof T2)
      try {
        ...
        if (h2.context = $2, h2.props = S2, h2.__P = n2, h2.__e = false, I2 = l.__r, A2 = 0, C2)
          h2.state = h2.__s, h2.__d = false, I2 && I2(u2), a3 = h2.render(h2.props, h2.state, h2.context), v.push.apply(h2.__h, h2._sb), h2._sb = [];
        else
          do {
        ...
        if (u2.__v = null, c5 || null != o2)
          ...
          u2.__e = t3.__e, u2.__k = t3.__k, n3.then || N(u2);
        l.__e(n3, u2, t3);
      }
    else
      null == o2 && u2.__v == t3.__v ? (u2.__k = t3.__k, u2.__e = t3.__e) : f2 = u2.__e = B(t3.__e, u2, t3, i2, r2, o2, e2, c5, s2);
  ...
  if (null == x3)
    ...
    if (e2 = e2 && n.call(u2.childNodes), !c5 && null != e2)
      for (b = {}, a3 = 0; a3 < u2.attributes.length; a3++)
        b[(w2 = u2.attributes[a3]).name] = w2.value;
    for (a3 in b)
      w2 = b[a3], "dangerouslySetInnerHTML" == a3 ? v2 = w2 : "children" == a3 || a3 in k2 || "value" == a3 && "defaultValue" in k2 || "checked" == a3 && "defaultChecked" in k2 || F(u2, a3, null, w2, o2);
    for (a3 in k2)
      w2 = k2[a3], "children" == a3 ? y3 = w2 : "dangerouslySetInnerHTML" == a3 ? h2 = w2 : "value" == a3 ? _2 = w2 : "checked" == a3 ? m3 = w2 : c5 && "function" != typeof w2 || b[a3] === w2 || F(u2, a3, w2, b[a3], o2);
    if (h2)
      c5 || v2 && (h2.__html == v2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t3.__k = [];
    else if (v2 && (u2.innerHTML = ""), P("template" == t3.type ? u2.content : u2, d(y3) ? y3 : [y3], t3, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e2, f2, e2 ? e2[0] : i2.__k && S(i2, 0), c5, s2), null != e2)
      for (a3 = e2.length; a3--; )
        g(e2[a3]);
...
function E(n2, u2, t3) {
  ...
  if (i2 = n2.__k)
    for (r2 = 0; r2 < i2.length; r2++)
      i2[r2] && E(i2[r2], u2, t3 || "function" != typeof n2.type);
